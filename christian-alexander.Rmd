---
title: "Food Swamps, Food Deserts, and Food Oases: Integrating Spatial Analysis and Census Data to Examine Community Food Environments and Socioeconomic Indicators in Henrico County and Virginia Beach City, VA"
author: 
...
This study examines how living in a food swamp, food desert, or food oasis shapes community health outcomes, with a focus on Virginia Beach City and Henrico County, Virginia. Using spatial analysis and Census data, we investigate how food environments relate to socioeconomic conditions and public health disparities.
...
map_va_beach <- ggplot(filter(va_map, County == "Virginia Beach city")) +
  ...
  labs(title = "Virginia Beach City") +
  theme_minimal() +
